...
import com.lemonsqueeze.lemonsqueezebe.exception.ErrorResponse;
...
@ControllerAdvice
public class ApplicationExcetionHandler extends ResponseEntityExceptionHandler{
    ...
    @ExceptionHandler({UserAlreadyExistsException.class, FollowingItselfException.class})
    public ResponseEntity<Object> handleUserAlreadyExistsException(RuntimeException e) {
        ErrorResponse errorResponse = new ErrorResponse(Arrays.asList(e.getMessage()));
